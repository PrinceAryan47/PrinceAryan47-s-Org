...
import { Mail, Lock, LogIn, Store, User, MessageCircle, Phone } from 'lucide-react';
      ...
      >
        <div className="p-8 space-y-8">
          <div className="text-center space-y-2">
            ...
            <p className="text-gray-500 text-sm">Access your HAM Grounds account</p>
          </div>
          ...
          <div className="text-center pt-4">
            <p className="text-sm text-gray-500">
              ...
              <Link to="/register" className="text-blue-600 font-bold hover:underline">Join HAM Grounds</Link>
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-50 p-6 text-center border-t border-gray-100">
            <p className="text-xs text-gray-400 font-medium leading-relaxed">
               ...
               Traders are verified for marketplace security.
            </p>
        </div>
      </motion.div>
    </div>
